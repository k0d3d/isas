  ...
  return function (req, res, next) {
    ...
    if (req.url === '/upload' && req.method.toLowerCase() === 'post') {
      ...
      busboy.on('file', function(fieldname, file, filename, encoding, mimeType) {
        ...
        var saveTo = fm.getChunkFilePath(fileParams._chunkNumber, fm.vault_fileId(fileParams));
      ...
      busboy.on('finish', function() {
        var validation = fm.validateRequest(req.fields._chunkNumber, req.fields._chunkSize, req.fields._totalSize, req.fields.identifier, req.fields.fileSize);
        if (validation !== 'valid') {
