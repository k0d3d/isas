...
function FileManagerFn () {
  ...
  this.sysTempDir = process.env.TMPDIR || process.env.TMP || process.env.TEMP;
  this.temporaryFolder = path.join(process.cwd(), 'chunks');
...
FileManagerFn.prototype.delete = function (identifier, callback){
  ...
  var filepath = path.join(process.cwd(), 'v4nish', identifier);
