...
function FileManagerFn () {
  ...
  this.vault_fileId = function (fileParams) {
    return [fileParams._folder, fileParams._owner, fileParams._chunkId, fileParams._totalSize].join('-');
  };

  this.setFields = function setFields (fields) {
    var self = {}, u = new Utility();
    ...
    self._owner = fields['x-Authr'] || fields['x-authr'] || 'anonymous';
